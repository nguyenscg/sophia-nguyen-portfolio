...
const HeroSection = () => {
    return (
        <section className="relative w-full h-screen flex flex-col items-center justify-center bg-background text-white text-center p-6">
            ...
            <h2 className="text=2xl md:text-3xl font-semibold mt-2 text-white">Python Developer & <span className="text-subtitles">Information Technology Infrastructure Student</span></h2>
            <p className="text-lg max-w-2xl mt-4 text-white">Passionate about building data-driven solutions and backend applications. 
