...
const HeroSection = () => {
    return (
        <section className="relative w-full h-screen flex flex-col items-center justify-center bg-deepPurple text-white text-center p-6">
            ...
            <h2 className="text=2xl md:text-3xl font-semibold mt-2">Python Developer & <span className="text-neonCyan">Information Technology Infrastructure Student</span></h2>
