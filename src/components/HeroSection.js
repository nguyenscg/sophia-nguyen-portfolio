...
const HeroSection = () => {
    return (
        <section className="relative w-full h-screen flex flex-col items-center justify-center bg-cloudmist text-black text-center p-6">
            ...
            <h2 className="text=2xl md:text-3xl font-semibold mt-2">Python Developer & <span className="text-moonlit">Information Technology Infrastructure Student</span></h2>
            <p className="text-lg max-w-2xl mt-4 text-midnight">Passionate about building data-driven solutions and backend applications. 
