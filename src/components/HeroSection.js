...
const HeroSection = () => {
    return (
        <section className="relative w-full h-screen flex flex-col items-center justify-center bg-background text-black text-center p-6">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mt-4 text-hmm">Hello, I'm <span className="text-primaryRose">Sophia Nguyen</span></h1>
            <h2 className="text=2xl md:text-3xl font-semibold mt-2 text-hmm">Python Developer & <span className="text-subtitles">Information Technology Infrastructure Student</span></h2>
