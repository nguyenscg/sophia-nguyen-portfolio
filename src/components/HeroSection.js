...
const HeroSection = () => {
    return (
        <section className="relative w-full h-screen flex flex-col items-center justify-center bg-background text-white text-center p-6">
            ...
            <h2 className="text=2xl md:text-3xl font-semibold mt-2"><span className="text-subtitle">Information Technology Infrastructure Student</span></h2>
            <p className="text-lg max-w-2xl mt-4 text-white">Passionate about building reliable and user-focused applications.
                I enjoy working with Python, Flask, and cloud technologies to make technology accessible to everyone.</p>
        </section>
    );
}
